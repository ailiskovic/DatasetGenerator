...
/**
 * Function which creates a new float element. 
 * @constructor
 */
export default function FloatElement({id, type, name, startValue, unitValue, increase, handleDelete, handleUpArrow, handleDownArrow, handleOnChange,
                                      handleOnChangeFloatOnly, handleButtonStateChange}) {
