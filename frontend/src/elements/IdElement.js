...
/**
 * Function which creates a new id element. 
 * @constructor
 */
export default function IdElement({id, type, name, startValue, increase, handleDelete, handleUpArrow, handleDownArrow, handleOnChange,
