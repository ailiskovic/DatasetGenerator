...
export default function CreateNewSample() {
  ...
  { 
    ...
    updateElementObjects( arr => [...arr, {id: id, type: elementTypes[1], name:"", startValue:"", unitValue:"", increase:true}]);
  }

  function handleFloatElement()
  { 
    let id = elementObjects.length
    updateElementObjects( arr => [...arr, {id: id, type: elementTypes[2], name:"", startValue:"", unitValue:"", increase:true}]);
   }
  ...
  {
    let id = elementObjects.length
    updateElementObjects( arr => [...arr, {id: id, type: elementTypes[3], name:"", dateValue: new Date(), timeValue: "0:0:0.0" , unitValue:"",  timeUnit: timeUnit[0], increase:true}]);
  }
  ...
  { 
    let id = elementObjects.length
    updateElementObjects( arr => [...arr, {id: id, type: elementTypes[8], name:"", lambdaValue:"", alphaValue:"", betaValue:""}]);
  }
  ...
  { 
    let id = elementObjects.length
    updateElementObjects( arr => [...arr, {id: id, type: elementTypes[10], name:"", x0Value:"", muValue:"", sigmaValue:""}]);
  }

  function handleRandomWalkBinomialDistributionElement()
  { 
    let id = elementObjects.length
    updateElementObjects( arr => [...arr, {id: id, type: elementTypes[11], name:"", x0Value:"", nTrialsValue:"", pValue:""}]);
  }
  ...
  return (
    ...
    <div className={styles.tab}>
        ...
        {elementObjects.map((el) => {
          ...
          <th>
          <Button onClick={testInput}>TEST_INPUT</Button>
          </th>
          </tr>
        </tbody>
        </Table>
